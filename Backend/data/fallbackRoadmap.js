      ...
      steps: [
        {
          ...
          description: "ES6+, async/await, closures.",
          duration: "2 weeks",
          resources: ["You Don't Know JS"],
        },
        {
          title: "React.js",
  ...
  "data science": {
    beginner: {
      ...
      steps: [
        {
          title: "Python Basics",
          description: "Learn core Python syntax and structures.",
          duration: "3 weeks",
...
export const defaultRoadmap = {
  ...
  steps: [
    {
      title: "Introduction",
      description: "Understand the basics of the field.",
      duration: "2 weeks",
      resources: ["Google Search", "YouTube"],
    },
    {
      title: "Core Concepts",
      description: "Learn the fundamental tools and theories.",
      duration: "4 weeks",
      resources: ["Coursera", "edX"],
    },
    {
      title: "Hands-on Projects",
      description: "Build starter projects to apply knowledge.",
      duration: "4 weeks",
      resources: ["GitHub"],
    },
    {
      title: "Advanced Topics",
      description: "Explore complex subjects.",
      duration: "2 weeks",
      resources: ["Medium", "Dev.to"],
    },
  ],
};
