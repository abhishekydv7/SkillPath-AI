import { fallbackRoadmap, defaultRoadmap } from "../data/fallbackRoadmap.js";
  ...
  return [
    {
      ...
      description:
        "Build a responsive personal portfolio using HTML, CSS, and basic JavaScript to showcase your skills.",
      difficulty: "beginner",
    ...
    },
    {
      ...
      description:
        "Create a full-stack to-do application with user authentication and database storage.",
    ...
    },
    {
      ...
      description:
        "Build a robust RESTful API for an e-commerce platform including payment integration simulation.",
      difficulty: "advanced",
