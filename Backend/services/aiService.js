...
import {
  ...
  generateFallbackProjects,
} from "./fallbackService.js";
  ...
  const formattedMessages = [
    {
      role: "system",
      content:
        "You are SkillPath AI, a friendly, encouraging, and highly knowledgeable technical mentor. Your goal is to help students learn programming, explain concepts simply (using analogies when helpful), and guide them on their projects. Keep answers concise but informative.",
    },
...
export const generateStepLesson = async (topic, description) => {
  ...
  try {
    ...
    return (
      completion.choices[0]?.message?.content || "Could not generate lesson."
    );
  } catch (error) {
